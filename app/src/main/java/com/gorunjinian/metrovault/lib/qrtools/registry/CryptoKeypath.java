...
import com.gorunjinian.metrovault.lib.qrtools.registry.pathcomponent.PathComponent;
    ...
    public static CryptoKeypath fromCbor(DataItem item) {
        ...
        for(DataItem key : map.getKeys()) {
            ...
            if(intKey == COMPONENTS_KEY) {
                ...
                sourceFingerprint = bigIntegerToBytes(((UnsignedInteger)map.get(key)).getValue());
